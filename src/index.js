...
// import 'node_modules/bootstrap/dist/css/bootstrap.css'  引用文件路径太长了，在webpack.config.js 文件中设置别名， alias: {
//   'bootstrap': path.resolve(__dirname, "node_modules/bootstrap/dist/css/bootstrap.css")
// }

import "bootstrap"   // 通过别名引用包

// --------------------------------------------------------引用第三方库，非node_module

import "dsf"   // 实验加载放到lib下的第三方模块，也可以是自己定义的模块
